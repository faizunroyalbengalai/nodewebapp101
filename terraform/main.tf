...
locals {
  ...
  _all_env = [
    ...
    { name = "SPRING_DATASOURCE_URL",     value = local._spring_ds_url },
    { name = "SPRING_DATASOURCE_USERNAME",value = local._spring_ds_user },
    { name = "SPRING_DATASOURCE_PASSWORD",value = local._spring_ds_pass },
